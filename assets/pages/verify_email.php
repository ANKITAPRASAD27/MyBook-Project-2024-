...
<div class="login">
                ...
                <?php
                    if(isset($_GET['resended']))
                    {
                       ...
                       ?>
                             ...
                             <p class="text-success">Verification code is resended</p>
        ...
        <?= showError('email_verify') ?>
                ...
                <div class="mt-3 d-flex justify-content-between align-items-center" id="btn-gap">
                   ...
                   <!-- PHP-PROJECT-2024\SOCIAL-MEDIA-2024/assets/php/action.php?resend_code-->
